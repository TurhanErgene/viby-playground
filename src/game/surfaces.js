...
export const SURFACES = {
  asphalt: { id: 'asphalt', label: 'Asphalt', gripMul: 1.00, drag: 0.0,  rough: 0.00, color: 0x30323c, demands: null },
  gravel:  { id: 'gravel',  label: 'Gravel',  gripMul: 0.82, drag: 0.9,  rough: 0.45, color: 0x584f42, demands: 'suspension' },
  sand:    { id: 'sand',    label: 'Sand',    gripMul: 0.70, drag: 2.6,  rough: 0.70, color: 0xb99a63, demands: 'suspension' },
  ice:     { id: 'ice',     label: 'Ice',     gripMul: 0.42, drag: -0.3, rough: 0.05, color: 0x9fc4d8, demands: 'grip' },
  water:   { id: 'water',   label: 'Standing water', gripMul: 0.60, drag: 3.4, rough: 0.25, color: 0x4a6b7a, demands: 'grip' },
